...
export const DETERMINANTE_SEGUNDA_COLUMNA_TYPE: string = 'dsc';
export const DETERMINANTE_TERCERA_COLUMNA_TYPE: string = 'dtc';
export const DETERMINANTE_CUARTA_COLUMNA_TYPE: string = 'dcc';
export const DETERMINANTE_QUINTA_COLUMNA_TYPE: string = 'dqc';
export const DETERMINANTE_PRIMERA_FILA_TYPE: string = 'dpf';
export const DETERMINANTE_SEGUNDA_FILA_TYPE: string = 'dsf';
export const DETERMINANTE_TERCERA_FILA_TYPE: string = 'dtf';
export const DETERMINANTE_CUARTA_FILA_TYPE: string = 'dcf';
export const DETERMINANTE_QUINTA_FILA_TYPE: string = 'dqf';
